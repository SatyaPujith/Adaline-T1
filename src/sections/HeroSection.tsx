...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      <div
        ref={heroContentRef}
        className="fixed top-1/3 sm:top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-20 w-full max-w-4xl px-4 sm:px-10 pointer-events-none"
        style={{ willChange: 'opacity, transform' }}
      >
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 2.2, ease: [0.215, 0.61, 0.355, 1] }}
          className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light text-white mb-4 sm:mb-6 leading-tight drop-shadow-lg"
        >
